...
AZURE_SEARCH_SERVICE = os.environ.get("hlbchatcognitivesearch")
AZURE_SEARCH_INDEX = os.environ.get("data")
AZURE_SEARCH_KEY = os.environ.get("fhU8hsBlhI2fOCOhSIuubfh5UsAF2Co30FKHcEEKxzAzSeBWWEBN")
...
AZURE_OPENAI_RESOURCE = os.environ.get("hlb-enterprise-open-ai")
AZURE_OPENAI_MODEL = os.environ.get("HLBChat")
AZURE_OPENAI_KEY = os.environ.get("fcda65fed6be4c63bd50fcfd092d1d64")
